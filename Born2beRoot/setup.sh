# knowledge
# 	hedifferences between aptitude and apt?
# 	AppArmor?
# 	virtual machine?
# 	debian vs sentos?
# 	interst of vm?
...
#     hostname:			mochegri42
#     root_pass:		1337@42
#     new_user:			chegashi/mochegri
#     new_user_pass:  	42@1337
#	encryoted password:	enc_b2br_1337@
	
	# use entire disk and set LVM
	# separet home partition
	# amount 30.8 G
	# do not use all partition
	# delete all partition
	# configue encryoted volume	
	# configue the logical volume manager
	# creat volume-group : LVMGroup
	# creat logical volume : swap /home /var /ser 	/tmp	/var/log
	...
	# sudo:
		...
		echo 'Defaults	passwd_tries=5' >> /etc/sudoers
		echo 'Defaults	badpass_message="Password is wrong, please try again"' >> /etc/sudoers
